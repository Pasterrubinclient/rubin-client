...
public class GuiScreen {
   ...
   public static ru.rubin.util.render.math.animation.anim2.Animation alpha = new ru.rubin.util.render.math.animation.anim2.Animation(
      Easing.EASE_OUT_SINE, 1500L
   );
   public static ru.rubin.util.render.math.animation.anim.Animation animation = new ru.rubin.util.render.math.animation.anim.Animation();
