...
import ru.rubin.module.api.Theme;
import ru.rubin.ui.gui.component.main.GuiCharTyped;
import ru.rubin.ui.gui.component.main.GuiInit;
import ru.rubin.ui.gui.component.main.GuiKeyPressed;
import ru.rubin.ui.gui.component.main.GuiMouseDragged;
import ru.rubin.ui.gui.component.main.GuiMouseReleased;
import ru.rubin.ui.gui.component.main.GuiMouseScrolled;
import ru.rubin.ui.gui.component.main.GuiShouldCloseOnEsc;
import ru.rubin.ui.gui.component.mouse.GuiMouseClicked;
import ru.rubin.ui.gui.component.render.GuiRender;
import ru.rubin.ui.gui.theme.ThemeScreen;
...
public class GuiClient extends Screen {
   ...
   public boolean mouseClicked(Click click, boolean bl) {
      Renderer2D renderer = Rubin.getRenderer();
   ...
   public void close() {
      ...
      Rubin.get.guiManager.setGuiCategory(GuiScreen.selectedCategories);
      super.close();
   }
   ...
   public void init() {
      ...
      if (Rubin.get.guiManager == null) {
         Rubin.get.guiManager = new GuiManager();
         Rubin.get.guiManager.init();
      }

      GuiScreen.selectedTheme = Rubin.get.guiManager.getCurrentTheme();
      GuiScreen.preSelectedTheme = Rubin.get.guiManager.getCurrentTheme();
      GuiScreen.selectedCategories = Rubin.get.guiManager.getCurrentCategory();
      if (Rubin.get.manager == null) {
         Rubin.get.manager = new Manager();
      }
