package ru.rubin.ui.gui.component.render;
...
import ru.rubin.util.render.backends.gl.StencilHelper;
...
public class GuiRenderLeftPanel extends GuiScreen {
   public static void renderLeftPanel(Renderer2D renderer2D, MatrixStack pose, float mainAlpha) {
      ...
      renderer2D.text(FontRegistry.INTER_MEDIUM, GuiScreen.x + 34.925F, GuiScreen.y + 213.355F + 7.0F, 14.0F, "NightUser", textColor);
      renderer2D.text(FontRegistry.INTER_MEDIUM, GuiScreen.x + 34.925F, GuiScreen.y + 220.89F + 7.0F, 13.0F, "Free", textTwoColor40);
      float checkNameX = renderer2D.measureText(FontRegistry.INTER_MEDIUM, "NightUser", 14.0F).width;
