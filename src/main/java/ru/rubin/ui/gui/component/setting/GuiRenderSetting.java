package ru.rubin.ui.gui.component.setting;
...
import ru.rubin.module.api.setting.impl.NoneSetting;
...
import ru.rubin.util.render.utils.KeyUtil;
...
public class GuiRenderSetting {
   ...
   public static float renderSetting(
      ...
      if (setting instanceof NoneSetting) {
         ...
         sliderAnim.update();
         sliderAnim.run(targetProgress, 0.24F, ru.rubin.util.render.math.animation.anim.util.Easings.QUART_OUT);
