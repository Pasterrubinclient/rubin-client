...
import ru.rubin.util.render.math.animation.Animation;
...
import ru.rubin.util.render.math.animation.impl.EaseInOutQuad;
...
public class TargetESP extends Module {
   ...
   private static final Identifier TARGET_TEXTURE = Identifier.of("rubin", "textures/world/target.png");
   private static final Identifier TARGET_TEXTURE_C = Identifier.of("rubin", "textures/world/targetn2.png");
   private static final Identifier TARGET_TEXTURE_N = Identifier.of("rubin", "textures/world/targetn.png");
   private static final Identifier GLOW_TEXTURE = Identifier.of("rubin", "textures/world/glow.png");
   ...
   private static final RenderPipeline COLOR_QUADS_PIPELINE = RenderPipelines.register(
         RenderPipeline.builder(new Snippet[] { RenderPipelines.POSITION_COLOR_SNIPPET })
               .withLocation(Identifier.of("rubin", "pipeline/world/color_quads"))
   ...
   private static final RenderPipeline CUBE_LINES_PIPELINE = RenderPipelines.register(
         RenderPipeline.builder(new Snippet[] { RenderPipelines.POSITION_COLOR_SNIPPET })
               .withLocation(Identifier.of("rubin", "targetesp_cube_lines"))
