...
public class WaterMark {
   ...
   public static void waterMark(Renderer2D r2) {
      ...
      r2.text(FontRegistry.ICONS, x + 12.27F, y + 30.0F, 40.0F, "p", Renderer2D.ColorUtil.getMainColor(1, 1));
      r2.text(FontRegistry.INTER_SEMIBOLD, x + 42.0F, y + 25.5F, 30.0F, "Rubin", Renderer2D.ColorUtil.getTextColor(1, 1));
