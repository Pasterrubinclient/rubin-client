...
import ru.rubin.util.render.math.animation.AnimationUtils;
import ru.rubin.util.render.math.animation.anim2.Animation;
...
public class Trails extends Module {
   ...
   private final Identifier bloom = Identifier.of("rubin", "textures/world/firefly.png");
