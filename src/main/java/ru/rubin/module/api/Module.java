...
import ru.rubin.module.api.setting.Config;
...
import ru.rubin.module.api.setting.impl.StringSetting;
import ru.rubin.module.impl.visuals.Hud;
import ru.rubin.util.render.animation.util.Animation;
import ru.rubin.util.render.core.Renderer2D;
import ru.rubin.util.render.math.animation.Translate;
...
public class Module extends Config {
   ...
   public ru.rubin.util.render.math.animation.Animation animation1 = new EaseInOutQuad(300, 1.0);
   public ru.rubin.util.render.math.animation.Animation animation2 = new EaseInOutQuad(300, 1.0);
   public final Animation2 mAnim = new Animation2();
   public ru.rubin.util.render.math.animation.Animation animation3 = new EaseInOutQuad(300, 1.0);
   public ru.rubin.util.render.math.animation.Animation animation4 = new EaseInOutQuad(300, 1.0);
