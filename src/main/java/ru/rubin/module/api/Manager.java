...
public class Manager {
   ...
   public Manager() {
      ...
      this.module.add(new ru.rubin.module.impl.movement.TargetStrafe());
      this.module.add(new ru.rubin.module.impl.movement.ElytraGlide());
      this.module.add(new ru.rubin.module.impl.visuals.GlassHands());
      this.module.add(new ru.rubin.module.impl.misc.PotionTracker());
      this.module.add(new ru.rubin.module.impl.misc.AuctionHelper());
      this.module.add(new ru.rubin.module.impl.misc.AutoLeave());
      this.module.add(new ru.rubin.module.impl.misc.AutoWarp());
      this.module.add(new ru.rubin.module.impl.misc.WardenHelper());
      this.module.add(new ru.rubin.module.impl.misc.DanjHelper());
      this.module.add(new ru.rubin.module.impl.misc.AutoClanUpgrade());
      this.module.add(new ru.rubin.module.impl.misc.ServerHelper());
      this.module.add(new ru.rubin.module.impl.misc.CameraClip());
      this.module.add(new ru.rubin.module.impl.visuals.BlockESP());
