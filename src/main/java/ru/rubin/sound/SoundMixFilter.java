...
import ru.rubin.sound.filters.FilterLowPass;
import ru.rubin.sound.filters.FilterReverb;
...
public class SoundMixFilter {
   ...
   public void updateMixer() {
      ...
      this.setState(Rubin.get.manager.getModule(RTXSounds.class).enable);
      if (this.state) {
