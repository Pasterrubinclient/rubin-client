package ru.rubin.util.render.math.animation.anim;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import ru.rubin.util.render.math.animation.anim.bezier.Bezier;
import ru.rubin.util.render.math.animation.anim.bezier.list.CubicBezier;
import ru.rubin.util.render.math.animation.anim.util.Easing;
