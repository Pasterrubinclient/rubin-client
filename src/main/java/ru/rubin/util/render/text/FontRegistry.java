package ru.rubin.util.render.text;
...
public final class FontRegistry {
   ...
   private static void registerBuiltinFonts() {
      INTER_MEDIUM = register("inter_medium", "assets/Rubin/fonts/medium.json", "assets/Rubin/fonts/medium.png");
      ICONS = register("icons", "assets/Rubin/fonts/icons.json", "assets/Rubin/fonts/icons.png");
      INTER_SEMIBOLD = register("inter_semibold", "assets/Rubin/fonts/semibold.json", "assets/Rubin/fonts/semibold.png");
   }
