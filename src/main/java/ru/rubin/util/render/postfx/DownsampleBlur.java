package ru.rubin.util.render.postfx;
...
import ru.rubin.util.render.backends.gl.ShaderProgram;
import ru.rubin.util.render.core.RenderFrameMetrics;
   ...
   public DownsampleBlur(int intermediateInternalFormat, int intermediatePixelType) {
      if (intermediateInternalFormat == 0) {
         ...
         this.downsampleProgram = ShaderProgram.fromResources(
            "assets/Rubin/shaders/blur/blur_fullscreen.vert", "assets/Rubin/shaders/blur/blur_downsample.frag"
         );
         this.upsampleProgram = ShaderProgram.fromResources("assets/Rubin/shaders/blur/blur_fullscreen.vert", "assets/Rubin/shaders/blur/blur_upsample.frag");
         this.smallHProgram = ShaderProgram.fromResources(
            "assets/Rubin/shaders/blur/blur_fullscreen.vert", "assets/Rubin/shaders/blur/blur_small_horizontal.frag"
         );
         this.smallVProgram = ShaderProgram.fromResources(
            "assets/Rubin/shaders/blur/blur_fullscreen.vert", "assets/Rubin/shaders/blur/blur_small_vertical.frag"
         );
