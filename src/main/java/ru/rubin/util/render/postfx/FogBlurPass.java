...
public final class FogBlurPass {
   ...
   private final ShaderProgram program = ShaderProgram.fromResources(
      "assets/Rubin/shaders/blur/blur_fullscreen.vert", "assets/Rubin/shaders/postfx/fog_blur.frag"
   );
   private final ShaderProgram copyProgram = ShaderProgram.fromResources(
      "assets/Rubin/shaders/blur/blur_fullscreen.vert", "assets/Rubin/shaders/postfx/fog_copy.frag"
   );
