package ru.rubin.util.render.backends.gl;
...
import ru.rubin.util.render.postfx.DepthRenderTarget;
import ru.rubin.util.render.postfx.DownsampleBlur;
...
public final class GlBackend {
   ...
   public GlBackend() {
      ...
      if (this.ssboSupported || instancedArraysSupported && drawInstancedSupported) {
         String vertexShaderPath = this.ssboSupported ? "assets/Rubin/shaders/shape.vert"
               : "assets/Rubin/shaders/shape_compat.vert";
         this.shapeProgram = ShaderProgram.fromResources(vertexShaderPath, "assets/Rubin/shaders/shape.frag");
   ...
   private ShaderProgram ensureFullscreenProgram() {
      if (this.fullscreenProgram != null) {
         ...
         String vertex = ResourceUtils.readText("assets/Rubin/shaders/blur/blur_fullscreen.vert");
